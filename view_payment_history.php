...
<html>
<head>
    <title>Admin | Student Fee History</title>
...
<div class="sidebar">
    ...
    <a href="admin_admissions.php">🎓 Admissions</a>
    <a href="upload_result.php">📊 Upload Results</a>
    <a href="admin_view_results.php">📄 Download Results</a>
    <a href="admin_subjects.php">📚 Subjects</a>
    <a href="admin_upload_syllabus.php">📝 Syllabus</a>
    <a href="admin_cbc_tracker.php">📝 CBC Tracker</a>	
    <a href="admin_upload_media.php">🖼️ Media Gallery</a>
    <a href="subscribers.php">🖼️ Subscribers</a>
    <a href="upload_news.php">📰 News & Events</a>
    <a href="admin_contact.php">📩 Contact Messages</a>
    <a href="admin_contact_student.php">📩 Contact Students Messages</a>
    ...
    <a href="admin_upload_teacher.php">Testimonials</a>
